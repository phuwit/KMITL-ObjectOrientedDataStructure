...
print("*** Rabbit & Turtle ***")
input_string: str = input("Enter Input : ")
(initial_distance, speed_rabbit, speed_turtle, speed_fly) = [
    int(n) for n in input_string.split(" ")
]

speed_delta = speed_turtle - speed_rabbit
time_catchup = initial_distance / speed_delta
fly_distance = time_catchup * speed_fly
